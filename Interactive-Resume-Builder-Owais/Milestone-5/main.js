document.addEventListener('DOMContentLoaded', function () {
    ...
    function generateResume() {
        ...
        (_a = document.getElementById('resume-actions')) === null || _a === void 0 ? void 0 : _a.classList.remove('hidden');
    }
    ...
    if (shareButton) {
        shareButton.addEventListener('click', function () {
            var resumeUrl = window.location.href; // Get the current page URL
    ...
    var printButton = document.getElementById('download-resume');
    if (printButton) {
