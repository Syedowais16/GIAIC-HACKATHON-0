document.addEventListener('DOMContentLoaded', function () {
    ...
    function generateResume() {
        ...
        var educationHtml = Array.prototype.map.call(educationItems, function (item) {
            ...
            return "<li><strong>".concat(institution, "</strong> - ").concat(degree, " (").concat(years, ")</li>");
        }).join('');
        var workItems = document.querySelectorAll('.work-item');
        var workHtml = Array.prototype.map.call(workItems, function (item) {
            ...
            return "<li><strong>".concat(company, "</strong> - ").concat(role, " (").concat(years, ")</li>");
        }).join('');
        var projectItems = document.querySelectorAll('.project-item');
        var projectHtml = Array.prototype.map.call(projectItems, function (item) {
            var projectName = item.querySelector('.project-name').value;
            var projectDescription = item.querySelector('.project-description').value;
            return "<li><strong>".concat(projectName, "</strong>: ").concat(projectDescription, "</li>");
        }).join('');
        var skills = document.getElementById('skills').value.split(',').map(function (skill) { return "<span class=\"skill\">".concat(skill.trim(), "</span>"); }).join('');
        resumeContent.innerHTML = "\n            <h2>".concat(nameInput, "</h2>\n            <p>Title: ").concat(titleInput, "</p>\n            <p>Email: ").concat(emailInput, "</p>\n            <p>Phone: ").concat(phoneInput, "</p>\n            <section id=\"education\">\n                <h2>Education</h2>\n                <ul>").concat(educationHtml, "</ul>\n            </section>\n            <section id=\"skills\">\n                <h2>Skills</h2>\n                <div class=\"skills-list\">").concat(skills, "</div>\n            </section>\n            <section id=\"work-experience\">\n                <h2>Work Experience</h2>\n                <ul>").concat(workHtml, "</ul>\n            </section>\n            <section id=\"projects\">\n                <h2>Projects</h2>\n                <ul>").concat(projectHtml, "</ul>\n            </section>\n        ");
